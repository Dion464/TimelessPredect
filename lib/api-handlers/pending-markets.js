      ...
      if (req.method === 'PATCH') {
        ...
        try {
          ...
          if (notificationType && updatedMarket.creator) {
            ...
            console.log(`[pending-markets/index] Notification sent to ${updatedMarket.creator}`);
          }
        } catch (notifError) {
          console.error(`[pending-markets/index] Failed to send notification:`, notifError);
