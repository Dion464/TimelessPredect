...
async function main() {
    ...
    const contract = await ETHPredictionMarket.attach("0x18E317A7D70d8fBf8e6E893616b52390EbBdb629");
    ...
    try {
        ...
        if (activeMarkets.length > 0) {
            ...
            // Check prices after YES buy
            console.log("\n📊 Prices after YES buy:");
            const [yesPriceAfter1, noPriceAfter1] = await pricingAMMContract.calculatePrice(marketId);
            console.log("YES price:", (yesPriceAfter1.toNumber() / 100).toFixed(0) + "¢");
            console.log("NO price:", (noPriceAfter1.toNumber() / 100).toFixed(0) + "¢");
            ...
            console.log("YES price:", (yesPriceAfter2.toNumber() / 100).toFixed(0) + "¢");
            console.log("NO price:", (noPriceAfter2.toNumber() / 100).toFixed(0) + "¢");
            ...
            // Check prices after NO buy
            console.log("\n📊 Prices after NO buy:");
            const [yesPriceAfter3, noPriceAfter3] = await pricingAMMContract.calculatePrice(marketId);
            console.log("YES price:", (yesPriceAfter3.toNumber() / 100).toFixed(0) + "¢");
            console.log("NO price:", (noPriceAfter3.toNumber() / 100).toFixed(0) + "¢");
