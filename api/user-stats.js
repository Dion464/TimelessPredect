 ...
 */
export default async function handleUserStats(req, res) {
  try {
    // Extract address from params (Express) or URL pathname (Vercel-style)
    ...
    const trades = await prisma.trade.findMany({
      ...
      include: {
        // We'll join market data manually since Prisma doesn't support BigInt joins easily
      }
    });
